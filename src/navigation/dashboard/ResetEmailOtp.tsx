...
const ResetEmailOtp = ({ route, navigation }: Props) => {
          ...
          <View style={{ flex: 1 }}>
            <View style={styles.labelsContainer}>
              <ScreenTitle
                ...
                styles={{ textTransform: "capitalize", marginBottom: 5 }}
              />
              <ScreenText
                label={
                  "Please enter 6-digit code we have sent to your email address"
                }
